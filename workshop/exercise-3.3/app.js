...
for (i = 0; i < allButtons.length; i++) {
    ...
    allButtons[i].style.margin = "30px 30px";
    ...
    allButtons[i].style.left = `${Math.random() * 600}px`;
    allButtons[i].style.top = `${Math.random() * 600}px`;

    // if (i % 2 === Math.floor(Math.random()) * 100) {
    //     allButtons[i].style.left = 100 + "px";
    //     allButtons[i].style.top = 100 + "px";
    // } else if (i === Math.floor(Math.random()) * 8) {
    //     allButtons[i].style.left = i + "px";
    //     allButtons[i].style.top = i + "px";
    // }
